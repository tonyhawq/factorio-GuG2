...
data:extend({
    {
        ...
        prerequisites = {"mechanics-2", "glassworking-1"},
        unit =
        {
            count = 30,
            ingredients =
...
data:extend({
    {
        ...
        effects =
        {
            {
                type = "unlock-recipe",
                recipe="flue-gas-void-1",
            },
            {
                type = "unlock-recipe",
                recipe="wood-oil-gasification",
            },
            {
                type = "unlock-recipe",
...
data:extend({
    {
        ...
        effects =
        {
            ...
            {
                type = "unlock-recipe",
                recipe="pine-sapling-1",
            },
            {
                type = "unlock-recipe",
                recipe="oak-sapling-1",
            },
            {
                type = "unlock-recipe",
            ...
            {
                type = "unlock-recipe",
                recipe="pine-tree-growing-1",
            },
            {
                type = "unlock-recipe",
                recipe="oak-tree-growing-1",
            },
            {
                type = "unlock-recipe",
                recipe="tree-tapping-1",
            },
            {
                type = "unlock-recipe",
                recipe="pine-tree-tapping-1",
            },
        },
    },
})
...
data:extend({
    {
        ...
        effects =
        {
            ...
            {
                type = "unlock-recipe",
                recipe="native-biofilm-1",
            },
            {
                type = "unlock-recipe",
                recipe="native-biofilm-2",
            },
            {
                type = "unlock-recipe",
...
data:extend({
    {
        ...
        effects =
        {
            {
                type = "unlock-recipe",
                recipe="nauvisworm-hatching-1",
            },
            {
                type = "unlock-recipe",
                recipe="nauvisworm-reproduction-1",
            },
            {
                type = "unlock-recipe",
                recipe="composter",
            ...
            {
                type = "unlock-recipe",
                recipe="compost-pale-gull-egg",
            },
            {
                type = "unlock-recipe",
                recipe="compost-saltberries",
            },
            {
                type = "unlock-recipe",
                recipe="compost-thalorain",
            },
            {
                type = "unlock-recipe",
                recipe="compost-rich-soil",
            },
            {
                type = "unlock-recipe",
                recipe="rich-soil-compost",
            },
            {
                type = "unlock-recipe",
                recipe="rich-soil-organic-wastewater",
            },
        },
    },
})
data:extend({
    {
        ...
        effects =
        {
            ...
            {
                type = "unlock-recipe",
                recipe="thalorain-grain-1",
            },
            {
                type = "unlock-recipe",
                recipe="sweet-thalorain-grain-1",
            },
        },
    },
})
...
data:extend({
    {
        ...
        prerequisites = {"chemistry-2", "pale-gull-breeding"},
        unit =
        {
            count = 20,
            ingredients =
